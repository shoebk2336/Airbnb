...
const SelectorField=[
    {title:"Adults",subTitle:"Ages 13 or above",val:Guests.values.Adults},
    {title:"Childrens",subTitle:"Ages 2-12",val:Guests.values.Childrens},
    {title:"Infants",subTitle:"Under 2",val:Guests.values.Infants},
    {title:"Pets",subTitle:"Bringing a service animals",val:Guests.values.Pets},
]
        ...
        return(<>
            {SearchReducer.ShowGuestSelector?
                ...
                >
                {
                    ...
                    <Text fw={500} c='dimmed'>{selector?.subTitle}</Text>
                    </Box>
                    <Flex justify='space-between'
                    w='80px'>
                    <ActionIcon variant="default" style={{borderRadius:"50%"}}
                    ...
                    {index==SelectorField.length-1?null:
                        <Divider/>
                    }
                    </>
